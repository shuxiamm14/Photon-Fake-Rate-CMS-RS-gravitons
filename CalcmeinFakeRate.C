...
void test(int numbersigmas = 0, Bool_t debugtest = true, TString region = "5-8")
{
 ...
 // for(unsigned int k = 0;k<1;k++){
     ...
     // canvas->Print(("Endcapfits_SideBand_"+region+"GeV"+binstring+".png").Data());
     // canvas->Print(("Endcapfits_"+region+binstring+".C").Data());
   ...
   //// FRGraph->SetName(FakeRate.Data());
    ...
    // **********************************************************-//
     ...
     //  *****************************************
	  ...
	  TString FakeRateFunctionName = "FakeRateFunctionJetRun2012ABCD13JulLoose"+VarString[l]; 
   ...
   // canvas->Print(("End.png").Data(),"png");
    ...
    // ********************************************
	  ...
	  cout<<FRfunc->GetParError(0)<<" "
	   ...
	   canvas->Print(("FakeRateJetRun2012ABCD13JulLoose"+VarString[l]+".png").Data(),"png");
    //  canvas->Print(("FakeRate"+l+".png").Data(),"png");
	  /*if(!debugtest){
...
//	    canvas->Print(("FakeRateJetRun2012ABCD13JulLoose.eps").Data(),"eps");
   ...
   // canvas->Print(("EndcapFakeRate.png").Data(),"png");
